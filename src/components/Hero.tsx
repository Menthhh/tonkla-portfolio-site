      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:tonklapokaew@gmail.com">
              <Button size="lg" className="bg-primary hover:bg-primary/90 text-white border-0">
                <Mail className="mr-2 h-5 w-5" />
                Get In Touch
              </Button>
            </a>
            <a href="https://github.com/Menthhh" target="_blank" rel="noopener noreferrer">
              <Button variant="outline" size="lg" className="bg-white/10 text-white border-white/30 hover:bg-white/20">
                <Github className="mr-2 h-5 w-5" />
                View GitHub
              </Button>
            </a>
            <a href="https://www.linkedin.com/in/tonkla-pokaew-018371255/" target="_blank" rel="noopener noreferrer">
              <Button variant="outline" size="lg" className="bg-white/10 text-white border-white/30 hover:bg-white/20">
